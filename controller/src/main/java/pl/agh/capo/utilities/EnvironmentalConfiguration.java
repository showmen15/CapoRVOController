...
public class EnvironmentalConfiguration {
	...
	public static final int SIMULATION_SLEEP_BETWEEN_TIME_STEP_IN_MS = 400; // SIMULATION_TIME_STEP_IN_MS;
	...
	public static final double VO_ROBOT_RADIUS = 1.6 * ROBOT_DIAMETER; // 1.6 *
																		// ROBOT_DIAMETER;
...
//	//CAPO dla Pojedycze Roboty dó³ 2
	public static double NEIGHBOR_DIST = 1.6f; // 1.1 ok // 0.6 dobre do obok siebie ale nie dla otwatej  //0.8 dla 1 na 1 (0.4 dla  
	public static int MAX_NEIGHBORS = 10;
	public static double TIME_HORIZON = 1.0f; //5.0
	...
	//Zasieg obserwacji
	public static double MAX_OBSERVATION_DISTANCE_FF =  1.0;  //do sprawdzenia
	
	//Zasieg dzialania przejscia 
