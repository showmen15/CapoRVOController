...
public final class Vector2
{
	...
	{
		return "(" + (new Float(x_)).toString((new CultureInfo("")).NumberFormat) + "," + (new Float(y_)).toString((new CultureInfo("")).NumberFormat) + ")";
	}*/
	 ...
	 * <param name="vector2">The second two-dimensional vector.</param>
	 */
	public static Vector2 OpAddition(Vector2 vector1, Vector2 vector2)
	{
	 ...
	 * <param name="vector2">The second two-dimensional vector.</param>
	 */
	public static Vector2 OpSubtraction(Vector2 vector1, Vector2 vector2)
	{
		return new Vector2(vector1.x_ - vector2.x_, vector1.y_ - vector2.y_);
	}
	 ...
	 * <param name="vector">The two-dimensional vector.</param>
	 */
	public static Vector2 OpUnaryNegation(Vector2 vector)
	{
