package pl.agh.capo.utilities.maze;
...
public class MazeMap {
	...
	public static MazeMap loadMazeFromFile(File mazeMapFile) throws Exception
	{
		Gson gson = new Gson();
		return gson.fromJson(new FileReader(mazeMapFile), MazeMap.class);
	}
