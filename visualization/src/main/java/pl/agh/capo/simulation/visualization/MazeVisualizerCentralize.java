...
import pl.agh.capo.simulation.test.Form1;
...
public class MazeVisualizerCentralize  extends JFrame implements StateReceivedCallback  {
		...
		private static final MazeVisualizerCentralize instance = new MazeVisualizerCentralize();

		private MazePanel mazePanel;
		private MazeMap mazeMap;

		private MazeVisualizerCentralize() {
			super("CAPO SIMULATION");
		}

		public static MazeVisualizerCentralize getInstance() {
			return instance;
		}
		...
		private File chooseFile(FileNameExtensionFilter filter) {
			...
			if (fileChooser.showOpenDialog(MazeVisualizerCentralize.this) != JFileChooser.APPROVE_OPTION) {
				return null;
			}
